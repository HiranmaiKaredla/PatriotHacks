...
st.set_page_config(page_title="Sophie", page_icon=":robot_face:")
st.markdown("<h2 style='text-align: center;'>Sophie - Your Friendly AI Companion.</h2>", unsafe_allow_html=True)
...
with container:
    ...
    if submit_button and user_input:
        ...
        cost = total_tokens * 0.002 / 1000 if model_name == "GPT-3.5" else (prompt_tokens * 0.03 + completion_tokens * 0.06) / 1000
